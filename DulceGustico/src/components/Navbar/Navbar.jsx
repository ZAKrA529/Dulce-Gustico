...
function NavigationBar() {
  return (
    <Navbar bg="dark" variant="dark" expand="lg" className="custom-navbar">
      <Container>
        <Navbar.Brand as={Link} to="/">Dulce Gustico</Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavDropdown title="Productos" id="productos-dropdown">
              ...
              <NavDropdown.Item as={Link} to="/productos/cupcakes">Cupcakes</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/productos/tortas">Tortas</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/productos/personalizados">Personalizados</NavDropdown.Item>
            </NavDropdown>
